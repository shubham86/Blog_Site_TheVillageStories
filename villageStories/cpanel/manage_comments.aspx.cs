...
{
    public partial class manage_comments : System.Web.UI.Page
    {
        ...
        private void fillRepeter(string category)
        {
            ...
            try
            {
                ...
                comm.CommandText = "proc_bologpost_fetchInRepeater_byComments";
        ...
        protected void rptrBlog_RowCommand(object sender, System.Web.UI.WebControls.RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("comment_details.aspx?ID=" + e.CommandArgument);
            }
        }
