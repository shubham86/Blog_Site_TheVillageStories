    ...
    public partial class search_results : System.Web.UI.Page
    {
        ...
        private void getBlogs(int PageIndex)
        {
            ...
            try
            {
                ...
                comm.CommandText = "proc_Blog_search";
                comm.Connection = conn;

                comm.Parameters.AddWithValue("searchText", Request.QueryString["search"].ToString());
                ...
                else
                {
                    ...
                    lblBlogAlert.Text = "No data Found related to \"" + Request.QueryString["search"].ToString() + "\".";
                }
