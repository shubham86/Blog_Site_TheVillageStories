    ...
    public partial class blogs : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    this.Page.Title = Request.QueryString["category"].ToString();
        ...
        private void getBlogs(int PageIndex)
        {
            ...
            try
            {
                ...
                comm.CommandText = "proc_Blog_fetchBy_Categories";
                comm.Connection = conn;

                comm.Parameters.AddWithValue("cat", Request.QueryString["category"].ToString());
